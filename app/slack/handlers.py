...
def register_handlers(app: App) -> None:
    ...
    def handle_mention(event: dict, say) -> None:
        ...
        answer = answer_question(question, user_id=user_id, channel_id=channel_id)
    ...
    def handle_dm(event: dict, say) -> None:
        ...
        if not is_authorized(channel_id, user_id):
            return
        answer = answer_question(event.get("text", ""), user_id=user_id, channel_id=channel_id)
        say(text=answer)
    ...
    def handle_ask_command(ack, respond, command: dict) -> None:
        ...
        if not question:
            ...
            return
        respond(answer_question(question, user_id=user_id, channel_id=channel_id))
